...
function registerAuthenticationStrategy(context, strategyClass) {
    return core_1.addExtension(context, keys_1.AuthenticationBindings.AUTHENTICATION_STRATEGY_EXTENSION_POINT_NAME, strategyClass, {
 ...
 */
exports.asAuthStrategy = binding => {
    core_1.extensionFor(keys_1.AuthenticationBindings.AUTHENTICATION_STRATEGY_EXTENSION_POINT_NAME)(binding);
    binding.tag({
        namespace: keys_1.AuthenticationBindings.AUTHENTICATION_STRATEGY_EXTENSION_POINT_NAME,
    });
};
